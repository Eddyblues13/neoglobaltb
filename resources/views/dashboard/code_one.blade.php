...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-warning">Enter a valid TAX CODE for this transaction.</div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        proceedToOtp.addEventListener('click', function () {
            ...
            .then(data => {
                ...
                if (data.success) {
                    window.location.href = "{{ route('loading_one') }}"; // Redirect to loading page
                } else {
            ...
            .catch(error => {
                document.getElementById('loadingOtp').style.display = 'none';
                toastr.error('An error occurred while validating the TAX CODE.');
            });
        });
    });
</script>