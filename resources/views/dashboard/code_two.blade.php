...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="alert alert-warning">Enter a valid OTP CODE for this transaction.</div>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        proceedToOtp.addEventListener('click', function () {
            ...
            .then(data => {
                ...
                if (data.success) {
                    window.location.href = "{{ route('loading_two') }}"; // Redirect to loading page
                } else {
