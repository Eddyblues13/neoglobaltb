...
<head>
    <meta charset="utf-8" />
    <title>Neoglobal Trust Bank| ACCOUNT</title>
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-4">
                                    ...
                                    <p>Get your free Neoglobal Trust Bankaccount now.</p>
                                </div>
                            </div>
                        ...
                        <div class="p-2">
                            <form method="POST" action="{{ route('register') }}" id="regester" class="needs-validation"
                                ...
                                <div class="mt-4 text-center">
                                    <p class="mb-0">By registering you agree to the Neoglobal Trust Banktb <a href="#"
                ...
                <div class="mt-5 text-center">
                    ...
                    <div>
                        ...
                        <p>©
                            ...
                            <i class="bx bx-check-shield text-success"></i>Neoglobal Trust Bank
                        </p>
                    </div>
                </div>
