...
<head>
	...
	<title>Neoglobal Trust Bank</title>
			...
			<tbody>
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<h2>Welcome to Neoglobal Trust Bank</h2>
						<br>
						<br>
						<p style='line-height: 24px;margin-bottom:15px;'>
							Thanks for joining Neoglobal Trust Bank as your new home. We're excited to have you on
							board!
						</p>
						<p style='line-height: 24px;margin-bottom:15px;'>
							Account Details:
				...
				<tr class="proton-tr">
					<td class="proton-td" colspan="10" style="">
						...
						<center>
							<span style="color: #706d6b"> © 2025 Neoglobal Trust Bank</span>
						</center>
